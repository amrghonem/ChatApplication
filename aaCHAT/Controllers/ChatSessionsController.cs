...
namespace aaCHAT.Controllers
{
    public class ChatSessionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,StartDate")] ChatSession chatSession)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,StartDate")] ChatSession chatSession)
        {
            if (ModelState.IsValid)
            {
